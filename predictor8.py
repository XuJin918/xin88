...
hard_food = st.selectbox(
    "您能咀嚼较硬的食物，如苹果吗？",
    options=[0, 1],
    format_func=lambda x: "可以，没有问题" if x == 0 else "可以，但是必须要小心 / 一点也不能"
)
...
childhood_economy = st.selectbox(
    "在您 18 岁之前，相对于那时您们家所在社区/村的普通家庭，您家的经济状况怎么样？",
    options=[0, 1],
    format_func=lambda x: "比他们好很多/比他们好一点/跟他们一样" if x == 0 else "比他们差一点/比他们差很多"
)
